...
import { privateDevices126167 } from './regimento-privativas-126-167';
import { finalDevices168209 } from './regimento-finais-168-209';
...
export const devices = [
  ...
  ...leisureDevices7090,
  ...leisureDevices91125,
  ...privateDevices126167,
  ...finalDevices168209,
].sort((a,b)=>a.article-b.article || a.id.localeCompare(b.id));
